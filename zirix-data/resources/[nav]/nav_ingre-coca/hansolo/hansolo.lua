...
Perm = Tunnel.getInterface("nav_ingre-coca")
-----------------------------------------------------------------------------------------------------------------------------------------
--[ Menu ]------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "comprar-querosene" then
		TriggerServerEvent("departamento-comprar","querosene")
    elseif data == "comprar-pastalq" then
		TriggerServerEvent("departamento-comprar","pasta-baixa")
